...
public class TextureAtlas {
    ...
    public static final Map<String, Vectors2f> atlas_title_coords = new HashMap<>();
    ...
    public static void fill(JsonObject atlas) {
        ...
        for (JsonObject.Member atlas_entry : atlas) {
            ...
            atlas_title_coords.put(key, new Vectors2f(coords.get(0).asFloat() * gl_crop_size, coords.get(1).asFloat() * gl_crop_size));
