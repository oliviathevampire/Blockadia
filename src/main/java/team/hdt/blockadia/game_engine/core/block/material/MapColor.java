package team.hdt.blockadia.game_engine.core.block.material;

import team.hdt.blockadia.game_engine.core.item.EnumVisualColor;
...
public class MapColor {
    ...
    static {
        BLOCK_COLORS[EnumVisualColor.WHITE.getMetadata()] = SNOW;
        BLOCK_COLORS[EnumVisualColor.ORANGE.getMetadata()] = ADOBE;
        BLOCK_COLORS[EnumVisualColor.MAGENTA.getMetadata()] = MAGENTA;
        BLOCK_COLORS[EnumVisualColor.LIGHT_BLUE.getMetadata()] = LIGHT_BLUE;
        BLOCK_COLORS[EnumVisualColor.YELLOW.getMetadata()] = YELLOW;
        BLOCK_COLORS[EnumVisualColor.LIME.getMetadata()] = LIME;
        BLOCK_COLORS[EnumVisualColor.PINK.getMetadata()] = PINK;
        BLOCK_COLORS[EnumVisualColor.GRAY.getMetadata()] = GRAY;
        BLOCK_COLORS[EnumVisualColor.SILVER.getMetadata()] = SILVER;
        BLOCK_COLORS[EnumVisualColor.CYAN.getMetadata()] = CYAN;
        BLOCK_COLORS[EnumVisualColor.PURPLE.getMetadata()] = PURPLE;
        BLOCK_COLORS[EnumVisualColor.BLUE.getMetadata()] = BLUE;
        BLOCK_COLORS[EnumVisualColor.BROWN.getMetadata()] = BROWN;
        BLOCK_COLORS[EnumVisualColor.GREEN.getMetadata()] = GREEN;
        BLOCK_COLORS[EnumVisualColor.RED.getMetadata()] = RED;
        BLOCK_COLORS[EnumVisualColor.BLACK.getMetadata()] = BLACK;
    }
    ...
    public static MapColor getBlockColor(EnumVisualColor dyeColorIn) {
