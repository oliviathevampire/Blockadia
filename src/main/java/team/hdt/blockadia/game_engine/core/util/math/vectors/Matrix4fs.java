...
public class Matrix4fs
    ...
    public Matrix4fs(Matrix4fs src) {
        load(src);
    }

    public static Matrix4fs setIdentity(Matrix4fs m) {
        m.m00 = 1.0F;
        m.m01 = 0.0F;
        m.m02 = 0.0F;
        m.m03 = 0.0F;
    ...
    public static Matrix4fs setZero(Matrix4fs m) {
        m.m00 = 0.0F;
        m.m01 = 0.0F;
        m.m02 = 0.0F;
        m.m03 = 0.0F;
    ...
    public static Matrix4fs load(Matrix4fs src, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
        dest.m00 = src.m00;
    ...
    public static Matrix4fs add(Matrix4fs left, Matrix4fs right, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
        left.m00 += right.m00;
    ...
    public static Matrix4fs sub(Matrix4fs left, Matrix4fs right, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
        left.m00 -= right.m00;
    ...
    public static Matrix4fs mul(Matrix4fs left, Matrix4fs right, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
    ...
    public static Vectors4f transform(Matrix4fs left, Vectors4f right, Vectors4f dest) {
        if (dest == null) {
            dest = new Vectors4f();
        }
    ...
    public static Matrix4fs scale(Vectors3f vec, Matrix4fs src, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
        src.m00 *= vec.x;
    ...
    public static Matrix4fs transpose(Matrix4fs src, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
        float m00 = src.m00;
    ...
    public static Matrix4fs invert(Matrix4fs src, Matrix4fs dest) {
    ...
    public static Matrix4fs negate(Matrix4fs src, Matrix4fs dest) {
        if (dest == null) {
            dest = new Matrix4fs();
        }
        dest.m00 = (-src.m00);
    ...
    public Matrix4fs load(Matrix4fs src) {
    ...
    public Matrixs store3f(FloatBuffer buf) {
        buf.put(this.m00);
        buf.put(this.m01);
        buf.put(this.m02);
        buf.put(this.m10);
    ...
    public Matrix4fs translate(Vectors2f vec) {
        return translate(vec, this);
    }

    public Matrix4fs translate(Vectors3f vec) {
        return translate(vec, this);
    }

    public Matrix4fs scale(Vectors3f vec) {
        return scale(vec, this, this);
    }

    public Matrix4fs rotate(float angle, Vectors3f axis) {
        return rotate(angle, axis, this);
    }

    public Matrix4fs rotate(float angle, Vectors3f axis, Matrix4fs dest) {
        return rotate(angle, axis, this, dest);
    }

    public Matrix4fs translate(Vectors3f vec, Matrix4fs dest) {
        return translate(vec, this, dest);
    }

    public Matrix4fs translate(Vectors2f vec, Matrix4fs dest) {
        return translate(vec, this, dest);
    }

    public Matrix4fs transpose(Matrix4fs dest) {
