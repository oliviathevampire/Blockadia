...
public class ShaderProgram {
    ...
    public ShaderProgram(MyFile vertexFile, MyFile fragmentFile) {
        int vertexShaderID = loadShaderAlt(vertexFile, GL20.GL_VERTEX_SHADER);
        int fragmentShaderID = loadShaderAlt(fragmentFile, GL20.GL_FRAGMENT_SHADER);
        programID = GL20.glCreateProgram();
        GL20.glAttachShader(programID, vertexShaderID);
        GL20.glAttachShader(programID, fragmentShaderID);
        GL20.glLinkProgram(programID);
    ...
    private int loadShaderAlt(MyFile file, int type) {
        StringBuilder shaderSource = new StringBuilder();
        try {
