...
public class MetaFile {
	...
	private static final int QUOTE_REPLACE = (int)QUOTE_REPLACEMENT;
	...
	private void loadLineSizes() {
		...
		horizontalPerPixelSize = verticalPerPixelSize / Main.getAspectRatio();
	}
