package net.timmy.th2.entity.layers;
...
public class LayerHeldItemWitch implements LayerRenderer<EntityMagicMaster> {
    private final RenderMagicMaster witchRenderer;

    public LayerHeldItemWitch(RenderMagicMaster witchRendererIn) {
        this.witchRenderer = witchRendererIn;
    }

    public void doRenderLayer(EntityMagicMaster entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
