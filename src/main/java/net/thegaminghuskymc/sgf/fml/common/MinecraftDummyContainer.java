...
import net.thegaminghuskymc.sgf.fml.common.versioning.VersionRange;
...
public class MinecraftDummyContainer extends DummyModContainer
{
    ...
    public MinecraftDummyContainer(String actualMCVersion)
    {
        ...
        getMetadata().modId = "sandboxgame";
        getMetadata().name = "Sandbox Game";
    ...
    {
        return new File("sandboxgame.jar");
    }
