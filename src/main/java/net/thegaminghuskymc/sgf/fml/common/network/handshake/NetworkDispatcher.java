...
package net.thegaminghuskymc.sgf.fml.common.network.handshake;
...
import net.thegaminghuskymc.sandboxgame.network.*;
import net.thegaminghuskymc.sandboxgame.network.play.server.SPacketCustomPayload;
...
import net.thegaminghuskymc.sgf.fml.common.network.FMLNetworkEvent;
import net.thegaminghuskymc.sgf.fml.common.network.NetworkRegistry;
import net.thegaminghuskymc.sgf.fml.common.network.internal.FMLMessage;
import net.thegaminghuskymc.sgf.fml.common.network.internal.FMLNetworkHandler;
import net.thegaminghuskymc.sgf.fml.common.network.internal.FMLProxyPacket;
...
public class NetworkDispatcher extends SimpleChannelInboundHandler<Packet<?>> implements ChannelOutboundHandler {
    ...
    private void completeClientSideConnection(ConnectionType type)
    {
        ...
        GameEngine.EVENT_BUS.post(new FMLNetworkEvent.ClientConnectedToServerEvent(manager, this.connectionType.name()));
    }
    ...
    private synchronized void completeServerSideConnection(ConnectionType type)
    {
        ...
        this.state = ConnectionState.CONNECTED;
        GameEngine.EVENT_BUS.post(new FMLNetworkEvent.ServerConnectionFromClientEvent(manager));
        if (DEBUG_HANDSHAKE)
