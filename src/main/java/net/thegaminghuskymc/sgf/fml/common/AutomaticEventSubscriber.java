...
public class AutomaticEventSubscriber
{
    ...
    public static void inject(ModContainer mod, ASMDataTable data, Side side)
    {
        ...
        Set<ASMDataTable.ASMData> mods = modData.get(ModInfo.class.getName());
        Set<ASMDataTable.ASMData> targets = modData.get(ModInfo.EventBusSubscriber.class.getName());
        ...
        for (ASMDataTable.ASMData targ : targets)
        {
            try
            {
                ...
                if (sides == DEFAULT || sides.contains(side)) {
                    ...
                    GameEngine.EVENT_BUS.register(subscriptionTarget);
