...
import net.thegaminghuskymc.sgf.fml.common.versioning.DefaultArtifactVersion;
import net.thegaminghuskymc.sgf.fml.common.versioning.VersionParser;
...
public class ModAPIManager {
    ...
    public void registerDataTableAndParseAPI(ASMDataTable dataTable)
    {
        ...
        Set<ASMDataTable.ASMData> apiList = dataTable.getAll("net.thegaminghuskymc.sandboxgameforge.fml.common.API");
