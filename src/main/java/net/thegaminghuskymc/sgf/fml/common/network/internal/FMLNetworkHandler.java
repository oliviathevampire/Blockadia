...
package net.thegaminghuskymc.sgf.fml.common.network.internal;
...
import net.thegaminghuskymc.sgf.fml.common.network.FMLEmbeddedChannel;
import net.thegaminghuskymc.sgf.fml.common.network.NetworkRegistry;
import net.thegaminghuskymc.sgf.fml.common.network.handshake.NetworkDispatcher;
import net.thegaminghuskymc.sgf.fml.common.registry.EntityRegistry;
    ...
    public static void openGui(EntityPlayer entityPlayer, Object mod, int modGuiId, World world, int x, int y, int z)
    {
        ...
        if (entityPlayer instanceof EntityPlayerMP && !(entityPlayer instanceof FakePlayer))
        {
            ...
            if (remoteGuiContainer != null)
            {
                ...
                GameEngine.EVENT_BUS.post(new PlayerContainerEvent.Open(entityPlayer, entityPlayer.openContainer));
            }
        }
