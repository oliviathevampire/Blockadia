...
import net.thegaminghuskymc.sgf.fml.common.gameevent.InputEvent;
import net.thegaminghuskymc.sgf.fml.common.gameevent.PlayerEvent;
import net.thegaminghuskymc.sgf.fml.common.gameevent.TickEvent;
import net.thegaminghuskymc.sandboxgame.nbt.NBTTagCompound;
import net.thegaminghuskymc.sgf.fml.common.thread.SidedThreadGroup;
import net.thegaminghuskymc.sgf.fml.relauncher.CoreModManager;
...
import net.thegaminghuskymc.sgf.fml.server.FMLServerHandler;
...
public class FMLCommonHandler
{
    ...
    private EventBus eventBus = GameEngine.EVENT_BUS;
     ...
     *
     * @Deprecated Use {@link GameEngine#EVENT_BUS} they're the same thing now
