...
import net.thegaminghuskymc.sgf.fml.common.discovery.ModCandidate;
import net.thegaminghuskymc.sgf.fml.common.event.FMLConstructionEvent;
import net.thegaminghuskymc.sgf.fml.common.event.FMLEvent;
import net.thegaminghuskymc.sgf.fml.common.event.FMLFingerprintViolationEvent;
import net.thegaminghuskymc.sgf.fml.common.versioning.ArtifactVersion;
import net.thegaminghuskymc.sandboxgame.modding.Mod;
...
public class FMLModContainer implements ModContainer
{
    ...
    private Method gatherAnnotations(Class<?> clazz) throws Exception
    {
        ...
        for (Method m : clazz.getDeclaredMethods())
        {
            ...
            {
                if (a.annotationType().equals(ModInfo.EventHandler.class))
                {
                ...
                else if (a.annotationType().equals(ModInfo.InstanceFactory.class))
                {
    ...
    private void processFieldAnnotations(ASMDataTable asmDataTable) throws Exception
    {
        ...
        parseSimpleFieldAnnotation(annotations, ModInfo.Instance.class.getName(), ModContainer::getMod);
        parseSimpleFieldAnnotation(annotations, ModInfo.Metadata.class.getName(), ModContainer::getMetadata);
    }
    ...
    public boolean shouldLoadInEnvironment()
    {
        ...
        GameEngine.Side side = FMLCommonHandler.instance().getSide();

        if (clientSideOnly && side != GameEngine.Side.CLIENT)
        {
            FMLLog.log.info("Disabling mod {} it is client side only.", getModId());
            return false;
        }

        if (serverSideOnly && side != GameEngine.Side.SERVER)
        {
