...
import net.thegaminghuskymc.sgf.fml.common.event.FMLInterModComms;
import net.thegaminghuskymc.sgf.fml.common.event.FMLLoadEvent;
import net.thegaminghuskymc.sgf.fml.common.event.FMLModIdMappingEvent;
...
public class Loader
{
     ...
     * above.
     *
     * If they provide the {@link net.thegaminghuskymc.sandboxgame.modding.ModInfo} annotation, they will be loaded as
     * "FML mods"
     *
    ...
    private ModDiscoverer identifyMods(List<String> additionalContainers)
    {
        ...
        mods.add(new InjectedModContainer(mcp,new File("sandboxgame.jar")));
