...
package net.thegaminghuskymc.sgf.fml.common.network;
...
public class FMLOutboundHandler extends ChannelOutboundHandlerAdapter {
    ...
    public enum OutboundTarget {
        ...
        /**
         * The packet is sent to all players within range of the {@link NetworkRegistry.TargetPoint} argument supplied.
         *
         * @author cpw
         *
         */
