...
package net.thegaminghuskymc.sgf.classloading;

import net.thegaminghuskymc.sgf.fml.relauncher.IFMLLoadingPlugin;
...
public class FMLForgePlugin implements IFMLLoadingPlugin
{
    ...
    {
        return "net.thegaminghuskymc.sandboxgameforge.common.ForgeModContainer";
    }
