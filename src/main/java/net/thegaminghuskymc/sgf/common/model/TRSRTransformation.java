...
package net.thegaminghuskymc.sgf.common.model;
...
import net.thegaminghuskymc.sandboxgame.client.renderer.block.model.ItemTransformVec3f;
import net.thegaminghuskymc.sandboxgame.client.renderer.block.model.ModelRotation;
import net.thegaminghuskymc.sandboxgame.util.math.Matrix3f;
import net.thegaminghuskymc.sandboxgame.util.math.Vector4f;
...
public final class TRSRTransformation implements IModelState, ITransformation
{
    ...
    @SideOnly(Side.CLIENT)
    public static Vector3f toVecmath(Vector3f vec)
    {
        return new Vector3f(vec.x, vec.y, vec.z);
    }

    @SideOnly(Side.CLIENT)
    public static Vector4f toVecmath(Vector4f vec)
    {
        return new Vector4f(vec.x, vec.y, vec.z, vec.w);
    }

    @SideOnly(Side.CLIENT)
    public static Matrix4f toVecmath(Matrix4f m)
    {
        return new Matrix4f(
    ...
    @SideOnly(Side.CLIENT)
    public static Vector3f toLwjgl(Vector3f vec)
    {
        return new Vector3f(vec.x, vec.y, vec.z);
    }

    @SideOnly(Side.CLIENT)
    public static Vector4f toLwjgl(Vector4f vec)
    {
        return new Vector4f(vec.x, vec.y, vec.z, vec.w);
    }

    @SideOnly(Side.CLIENT)
    public static Matrix4f toLwjgl(Matrix4f m)
    {
