...
package net.thegaminghuskymc.sgf.common;
...
import net.thegaminghuskymc.sandboxgame.block.BlockLiquid;
...
import net.thegaminghuskymc.sandboxgame.network.NetHandlerPlayServer;
import net.thegaminghuskymc.sandboxgame.network.play.server.SPacketBlockChange;
...
import net.thegaminghuskymc.sgf.event.entity.living.LivingEvent;
...
import net.thegaminghuskymc.sgf.registries.IForgeRegistry;
import net.thegaminghuskymc.sgf.registries.RegistryManager;
...
public class ForgeHooks
{
    ...
    {
        GameEngine.EVENT_BUS.post(new DifficultyChangeEvent(difficulty, oldDifficulty));
    }
    ...
    {
        GameEngine.EVENT_BUS.post(new LivingSetAttackTargetEvent(entity, target));
    }

    public static boolean onLivingUpdate(EntityLivingBase entity)
    {
        return GameEngine.EVENT_BUS.post(new LivingEvent.LivingUpdateEvent(entity));
    }

    public static boolean onLivingAttack(EntityLivingBase entity, DamageSource src, float amount)
    {
        return !GameEngine.EVENT_BUS.post(new LivingAttackEvent(entity, src, amount));
    }
    ...
    {
        return GameEngine.EVENT_BUS.post(new LivingDeathEvent(entity, src));
    }
    ...
    {
        return GameEngine.EVENT_BUS.post(new LivingDropsEvent(entity, source, drops, lootingLevel, recentlyHit));
    }
    ...
    public static float[] onLivingFall(EntityLivingBase entity, float distance, float damageMultiplier)
    {
        ...
        return (GameEngine.EVENT_BUS.post(event) ? null : new float[]{event.getDistance(), event.getDamageMultiplier()});
    }
    ...
    {
        GameEngine.EVENT_BUS.post(new LivingEvent.LivingJumpEvent(entity));
    }
    ...
    public static boolean onAnvilChange(ContainerRepair container, @Nonnull ItemStack left, @Nonnull ItemStack right, IInventory outputSlot, String name, int baseCost)
    {
        ...
        if (GameEngine.EVENT_BUS.post(e)) return false;
    ...
    public static boolean onNoteChange(TileEntityNote te, byte old)
    {
        ...
        if (GameEngine.EVENT_BUS.post(e))
        {
            te.note = old;
            return false;
        }
    ...
    {
        if (GameEngine.EVENT_BUS.post(new AttackEntityEvent(player, target))) return false;
        ItemStack stack = player.getHeldItemMainhand();
    ...
    {
        GameEngine.EVENT_BUS.post(new PlayerInteractEvent.RightClickEmpty(player, hand));
    }

    public static void onEmptyLeftClick(EntityPlayer player)
    {
        GameEngine.EVENT_BUS.post(new PlayerInteractEvent.LeftClickEmpty(player));
    }
    ...
    {
        GameEngine.EVENT_BUS.post(new BlockEvent.CropGrowEvent.Post(worldIn, pos, state, worldIn.getBlockState(pos)));
    }
    ...
    public static CriticalHitEvent getCriticalHit(EntityPlayer player, Entity target, boolean vanillaCritical, float damageModifier)
    {
        ...
        GameEngine.EVENT_BUS.post(hitResult);
    ...
    {
        GameEngine.EVENT_BUS.post(new AdvancementEvent(player, advancement));
    }
}