...
package net.thegaminghuskymc.sgf.common.chunkio;
...
import net.thegaminghuskymc.sandboxgame.world.gen.ChunkProviderServer;
import net.thegaminghuskymc.sgf.event.world.ChunkDataEvent;
...
class ChunkIOProvider implements Runnable
{
    ...
    public void syncCallback()
    {
        ...
        GameEngine.EVENT_BUS.post(new ChunkDataEvent.Load(this.chunk, this.nbt)); // Don't call ChunkDataEvent.Load async
