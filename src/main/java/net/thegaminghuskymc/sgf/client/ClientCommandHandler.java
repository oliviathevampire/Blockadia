...
import net.thegaminghuskymc.sandboxgame.command.*;
...
import net.thegaminghuskymc.sgf.event.CommandEvent;
import net.thegaminghuskymc.sgf.fml.client.FMLClientHandler;
import net.thegaminghuskymc.sgf.fml.common.FMLLog;

import java.util.List;

import static net.thegaminghuskymc.sandboxgame.util.text.TextFormatting.GRAY;
import static net.thegaminghuskymc.sandboxgame.util.text.TextFormatting.RED;
import static net.thegaminghuskymc.sandboxgame.util.text.TextFormatting.RESET;
