...
public class RegistryManager
{
    ...
    <V extends IForgeRegistryEntry<V>> ForgeRegistry<V> createRegistry(ResourceLocation name, Class<V> type, ResourceLocation defaultKey, int min, int max,
                                                                       @Nullable IForgeRegistry.AddCallback<V> add, @Nullable IForgeRegistry.ClearCallback<V> clear, @Nullable IForgeRegistry.CreateCallback<V> create,
                                                                       boolean persisted, boolean allowOverrides, boolean isModifiable, @Nullable IForgeRegistry.DummyFactory<V> dummyFactory, @Nullable IForgeRegistry.MissingFactory<V> missing)
    {
