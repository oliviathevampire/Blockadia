...
import net.thegaminghuskymc.sgf.common.crafting.IShapedRecipe;
...
public class ShapedOreRecipe extends IForgeRegistryEntry.Impl<IRecipe> implements IShapedRecipe
{
    ...
    /**
     * Based on {@link net.thegaminghuskymc.sandboxgame.item.crafting.ShapedRecipes#checkMatch(InventoryCrafting, int, int, boolean)}
     */
