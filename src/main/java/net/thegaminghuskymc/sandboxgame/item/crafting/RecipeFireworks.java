...
public class RecipeFireworks extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
        ...
        for (int k1 = 0; k1 < inv.getSizeInventory(); ++k1) {
            ...
            if (!itemstack.isEmpty()) {
                if (itemstack.getItem() == Items.GUNPOWDER) {
                    ...
                    ++l;
                } else if (DyeUtils.isDye(itemstack)) {
                    ++k;
                ...
                for (int l1 = 0; l1 < inv.getSizeInventory(); ++l1) {
                    ...
                    if (!itemstack2.isEmpty()) {
                        if (DyeUtils.isDye(itemstack2)) {
                            list.add(Integer.valueOf(ItemDye.DYE_COLORS[DyeUtils.rawDyeDamageFromStack(itemstack2) & 15]));
                ...
                for (int i2 = 0; i2 < inv.getSizeInventory(); ++i2) {
                    ...
                    if (!itemstack1.isEmpty()) {
                        if (net.minecraftforge.oredict.DyeUtils.isDye(itemstack1)) {
                            list1.add(Integer.valueOf(ItemDye.DYE_COLORS[DyeUtils.rawDyeDamageFromStack(itemstack1) & 15]));
