...
import net.thegaminghuskymc.sandboxgame.block.BlockDirt;
import net.thegaminghuskymc.sandboxgame.block.BlockPlanks;
import net.thegaminghuskymc.sandboxgame.block.BlockStone;
...
public class Item extends IForgeRegistryEntry.Impl<Item>
{
    ...
    /**
     * Returns whether this item is always allowed to edit the world. Forces
     * 
