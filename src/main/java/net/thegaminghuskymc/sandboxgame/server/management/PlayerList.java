...
import net.thegaminghuskymc.sandboxgame.network.play.server.SPacketChangeGameState;
import net.thegaminghuskymc.sandboxgame.network.play.server.SPacketChat;
...
public abstract class PlayerList {
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd) {
        ...
        FMLCommonHandler.instance().firePlayerRespawnEvent(entityplayermp, conqueredEnd);
