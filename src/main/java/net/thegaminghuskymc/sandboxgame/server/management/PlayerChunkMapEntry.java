...
import net.thegaminghuskymc.sandboxgame.network.play.server.SPacketChunkData;
    ...
    public boolean sendToPlayers() {
        if (this.sentToPlayers) {
            ...
            for (EntityPlayerMP entityplayermp : this.players) {
                ...
                GameEngine.EVENT_BUS.post(new net.minecraftforge.event.world.ChunkWatchEvent.Watch(this.pos, entityplayermp));
            }
