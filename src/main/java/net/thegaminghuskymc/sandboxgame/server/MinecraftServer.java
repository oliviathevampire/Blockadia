package net.thegaminghuskymc.sandboxgame.server;
...
import net.thegaminghuskymc.sandboxgame.command.CommandBase;
import net.thegaminghuskymc.sandboxgame.command.ICommandManager;
...
import net.thegaminghuskymc.sandboxgame.server.dedicated.DedicatedServer;
import net.thegaminghuskymc.sandboxgame.server.management.PlayerList;
import net.thegaminghuskymc.sandboxgame.server.management.PlayerProfileCache;
...
import net.thegaminghuskymc.sandboxgame.world.*;
...
import net.thegaminghuskymc.sgf.fml.common.StartupQuery;
...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo {
    ...
    public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String generatorOptions) {
        ...
        for (int dim : net.minecraftforge.common.DimensionManager.getStaticDimensionIDs()) {
            ...
            GameEngine.EVENT_BUS.post(new net.minecraftforge.event.world.WorldEvent.Load(world));
        }
        ...
        if (this.worlds != null) {
            ...
            for (WorldServer worldserver1 : this.worlds) {
                if (worldserver1 != null) {
                    GameEngine.EVENT_BUS.post(new net.minecraftforge.event.world.WorldEvent.Unload(worldserver1));
                    worldserver1.flush();
                }
            }
    ...
    public void startServerThread() {
        StartupQuery.reset();
        this.serverThread = new Thread(SidedThreadGroups.SERVER, this, "Server thread");
