...
import net.thegaminghuskymc.sandboxgame.util.EntitySelectors;
...
public class EntitySelector {
    ...
    public static <T extends Entity> List<T> matchEntities(ICommandSender sender, String token, Class<? extends T> targetClass) throws CommandException {
        return SelectorHandlerManager.matchEntities(sender, token, targetClass);
    }
            ...
            if (!isEntityTypeValid(sender, map)) {
                ...
                for (World world : list) {
                    if (world != null) {
                        ...
                        list2.addAll(GameRegistry.createEntitySelectors(map, s, sender, vec3d));
