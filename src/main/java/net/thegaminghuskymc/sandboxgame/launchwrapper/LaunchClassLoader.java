...
public class LaunchClassLoader extends URLClassLoader {
    ...
    public LaunchClassLoader(URL[] sources) {
        ...
        addClassLoaderExclusion("net.thegaminghuskymc.sandboxgame.launchwrapper.");
        ...
        addTransformerExclusion("net.thegaminghuskymc.sandboxgame.launchwrapper.injector.");
    ...
    public Class<?> findClass(final String name) throws ClassNotFoundException {
        ...
        try {
            ...
            if (lastDot > -1 && !untransformedName.startsWith("net.thegaminghuskymc.sandboxgame.")) {
