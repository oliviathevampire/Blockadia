package net.thegaminghuskymc.sandboxgame.potion;
...
import net.thegaminghuskymc.sandboxgame.entity.SharedMonsterAttributes;
import net.thegaminghuskymc.sandboxgame.entity.ai.attributes.AbstractAttributeMap;
import net.thegaminghuskymc.sandboxgame.entity.ai.attributes.AttributeModifier;
...
{
    public static final RegistryNamespaced<ResourceLocation, Potion> REGISTRY = GameData.getWrapper(Potion.class);
