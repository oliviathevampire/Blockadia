...
public class PotionEffect implements Comparable<PotionEffect>
{
    ...
    public PotionEffect(PotionEffect other)
    {
        ...
        this.curativeItems = other.curativeItems == null ? null : new java.util.ArrayList<ItemStack>(other.curativeItems);
    }
    ...
    private void writeCurativeItems(NBTTagCompound nbt)
    {
        ...
        for (ItemStack stack : getCurativeItems())
        {
    ...
    {
        if (nbt.hasKey("CurativeItems", Constants.NBT.TAG_LIST))
        {
            java.util.List<ItemStack> items = new java.util.ArrayList<>();
            NBTTagList list = nbt.getTagList("CurativeItems", Constants.NBT.TAG_COMPOUND);
