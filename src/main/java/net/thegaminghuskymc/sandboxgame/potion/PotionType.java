...
public class PotionType extends IForgeRegistryEntry.Impl<PotionType>
{
    ...
    public static final RegistryNamespacedDefaultedByKey<ResourceLocation, PotionType> REGISTRY = GameData.getWrapperDefaulted(PotionType.class);
    ...
    private static void registerPotionType(String p_185173_0_, PotionType p_185173_1_)
    {
