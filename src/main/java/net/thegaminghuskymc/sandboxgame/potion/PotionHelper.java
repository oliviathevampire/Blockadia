...
import net.thegaminghuskymc.sandboxgame.init.PotionTypes;
...
public class PotionHelper
{
    ...
    private static final List<MixPredicate<Item>> POTION_ITEM_CONVERSIONS = Lists.<PotionHelper.MixPredicate<Item>>newArrayList();
