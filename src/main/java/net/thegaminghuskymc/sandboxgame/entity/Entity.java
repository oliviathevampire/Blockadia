...
import net.thegaminghuskymc.sandboxgame.block.BlockFence;
import net.thegaminghuskymc.sandboxgame.block.BlockFenceGate;
...
import net.thegaminghuskymc.sandboxgame.command.CommandResultStats;
import net.thegaminghuskymc.sandboxgame.command.ICommandSender;
import net.thegaminghuskymc.sandboxgame.enchantment.EnchantmentProtection;
...
import net.thegaminghuskymc.sandboxgame.nbt.*;
...
import net.thegaminghuskymc.sandboxgame.util.text.event.HoverEvent;
...
public abstract class Entity implements ICommandSender, ICapabilitySerializable<NBTTagCompound> {
    ...
    /**
     * If true, an {@link net.thegaminghuskymc.sandboxgame.network.play.server.SPacketEntityVelocity} will be sent updating this entity's velocity.
     */
    ...
    public Entity(World worldIn) {
        ...
        this.entityInit();
        GameEngine.EVENT_BUS.post(new EntityEvent.EntityConstructing(this));
    ...
    public void move(MoverType type, double x, double y, double z) {
        if (this.noClip) {
            ...
            if (iblockstate.getMaterial() == Material.AIR) {
                ...
                if (block1 instanceof BlockFence || block1 instanceof BlockFenceGate) {
    ...
    public boolean isInsideOfMaterial(Material materialIn) {
        if (this.getRidingEntity() instanceof EntityBoat) {
            ...
            if (iblockstate.getMaterial() == materialIn) {
                return ForgeHooks.isInsideOfMaterial(materialIn, this, blockpos);
            } else {
                return false;
            }
        }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        ...
        if (!ForgeEventFactory.canMountEntity(this, entityIn, true)) return false;
    ...
    public void dismountRidingEntity() {
        if (this.ridingEntity != null) {
            ...
            if (!ForgeEventFactory.canMountEntity(this, entity, false)) return;
    ...
    public Entity changeDimension(int dimensionIn) {
        if (!this.world.isRemote && !this.isDead) {
            if (!ForgeHooks.onTravelToDimension(this, dimensionIn)) return null;
