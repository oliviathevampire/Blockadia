...
import net.thegaminghuskymc.sandboxgame.block.BlockHorizontal;
...
import net.thegaminghuskymc.sandboxgame.enchantment.EnchantmentHelper;
import net.thegaminghuskymc.sandboxgame.entity.*;
import net.thegaminghuskymc.sandboxgame.entity.ai.attributes.IAttribute;
import net.thegaminghuskymc.sandboxgame.entity.ai.attributes.IAttributeInstance;
import net.thegaminghuskymc.sandboxgame.entity.ai.attributes.RangedAttribute;
import net.thegaminghuskymc.sandboxgame.entity.item.EntityItem;
import net.thegaminghuskymc.sandboxgame.init.Items;
import net.thegaminghuskymc.sandboxgame.init.MobEffects;
import net.thegaminghuskymc.sandboxgame.init.SoundEvents;
import net.thegaminghuskymc.sandboxgame.inventory.Container;
import net.thegaminghuskymc.sandboxgame.inventory.ContainerPlayer;
import net.thegaminghuskymc.sandboxgame.inventory.EntityEquipmentSlot;
...
import net.thegaminghuskymc.sandboxgame.network.datasync.DataParameter;
import net.thegaminghuskymc.sandboxgame.network.datasync.DataSerializers;
import net.thegaminghuskymc.sandboxgame.network.datasync.EntityDataManager;
import net.thegaminghuskymc.sandboxgame.network.play.server.SPacketEntityVelocity;
import net.thegaminghuskymc.sandboxgame.scoreboard.ScorePlayerTeam;
import net.thegaminghuskymc.sandboxgame.scoreboard.Scoreboard;
import net.thegaminghuskymc.sandboxgame.scoreboard.Team;
import net.thegaminghuskymc.sandboxgame.stats.StatBase;
import net.thegaminghuskymc.sandboxgame.stats.StatList;
import net.thegaminghuskymc.sandboxgame.tileentity.TileEntitySign;
import net.thegaminghuskymc.sandboxgame.util.*;
import net.thegaminghuskymc.sandboxgame.util.datafix.*;
...
import net.thegaminghuskymc.sandboxgame.util.text.event.ClickEvent;
import net.thegaminghuskymc.sandboxgame.world.EnumDifficulty;
...
import net.thegaminghuskymc.sgf.fml.common.network.internal.FMLNetworkHandler;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
        if (ForgeHooks.onLivingDeath(this,  cause)) return;
        super.onDeath(cause);
        ...
        captureDrops = false;
        if (!world.isRemote) ForgeEventFactory.onPlayerDrops(this, cause, capturedDrops, recentlyHit > 0);
    ...
    public void writeEntityToNBT(NBTTagCompound compound)
    {
        ...
        FMLCommonHandler.instance().getDataFixer().writeVersionData(compound); //Moved down so it doesn't keep missing every MC update.
    ...
    protected void damageShield(float damage)
    {
        if (damage >= 3.0F && this.activeItemStack.getItem().isShield(this.activeItemStack, this))
        {
            ...
            if (this.activeItemStack.isEmpty())
            {
                ...
                ForgeEventFactory.onPlayerDestroyItem(this, copyBeforeUse, enumhand);
    ...
    public EnumActionResult interactOn(Entity p_190775_1_, EnumHand p_190775_2_)
    {
        ...
        {
            EnumActionResult cancelResult = ForgeHooks.onInteractEntity(this, p_190775_1_, p_190775_2_);
        ...
        if (targetEntity.canBeAttackedWithItem())
        {
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    net.minecraftforge.event.entity.player.CriticalHitEvent hitResult = ForgeHooks.getCriticalHit(this, targetEntity, flag2, flag2 ? 1.5F : 1.0F);
    ...
    {
        if(ForgeEventFactory.onPlayerSpawnSet(this, pos, forced)) return;
        if (this.dimension != 0)
        {
