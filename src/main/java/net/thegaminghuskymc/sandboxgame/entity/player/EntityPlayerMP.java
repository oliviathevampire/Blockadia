...
import net.thegaminghuskymc.sandboxgame.inventory.IContainerListener;
import net.thegaminghuskymc.sandboxgame.inventory.IInventory;
import net.thegaminghuskymc.sandboxgame.inventory.SlotCrafting;
...
import net.thegaminghuskymc.sandboxgame.network.play.server.*;
import net.thegaminghuskymc.sandboxgame.potion.PotionEffect;
import net.thegaminghuskymc.sandboxgame.scoreboard.*;
...
import net.thegaminghuskymc.sandboxgame.server.management.UserListOpsEntry;
...
import net.thegaminghuskymc.sandboxgame.util.text.*;
...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener
{
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (!this.world.getGameRules().getBoolean("keepInventory") && !this.isSpectator())
        {
            ...
            captureDrops = false;
            PlayerDropsEvent event = new net.minecraftforge.event.entity.player.PlayerDropsEvent(this, cause, capturedDrops, recentlyHit > 0);
    ...
    {
        if (!ForgeHooks.onTravelToDimension(this, dimensionIn)) return this;
    ...
    public void closeContainer()
    {
        ...
        GameEngine.EVENT_BUS.post(new net.minecraftforge.event.entity.player.PlayerContainerEvent.Close(this, this.openContainer));
        this.openContainer = this.inventoryContainer;
    }
