...
public class NoiseGenerator {
	...
	public static NoiseGenerator INSTANCE = new NoiseGenerator();
	...
	public static float[][] getNoise(int octave, int width, int height) {
		return generatePerlinNoise(
				generateSmoothNoise(generateWhiteNoise(width, height), octave),
				octave);
	}
