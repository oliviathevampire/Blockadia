...
public class Terrain {
    ...
    public Terrain(int terrainSize, float scale, float minY, float maxY, String heightMapFile, String textureFile, int textInc) throws Exception {
        ...
        gameItems = new Block[terrainSize * terrainSize];
        ...
        for (int row = 0; row < terrainSize; row++) {
            for (int col = 0; col < terrainSize; col++) {
                ...
                Block terrainBlock = new Block(heightMapMesh.getMesh());
    ...
    protected Vector3f[] getTriangle(Vector3f position, Box2D boundingBox, Block terrainBlock) {
    ...
    protected float getWorldHeight(int row, int col, Block gameItem) {
     ...
     */
    private Box2D getBoundingBox(Block terrainBlock) {
