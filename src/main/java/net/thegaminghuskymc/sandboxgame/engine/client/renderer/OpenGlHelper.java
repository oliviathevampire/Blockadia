package net.thegaminghuskymc.sandboxgame.engine.client.renderer;
...
import net.thegaminghuskymc.sandboxgame.engine.client.renderer.vertex.DefaultVertexFormats;
import net.thegaminghuskymc.sandboxgame.engine.util.Util;
...
public class OpenGlHelper
{
    ...
    public static void glShaderSource(int shaderIn, ByteBuffer string)
    {
        if (arbShaders)
        {
            ARBShaderObjects.glShaderSourceARB(shaderIn);
        }
        else
        {
            GL20.glShaderSource(shaderIn);
        }
    }
