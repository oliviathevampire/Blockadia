...
public class CollisionDetection {
     ...
     *
     * @param b1 : a moving object on which we test collision toward b2
     * @param b2 : an object statically considered
     * @param dt : the time length during b1 moves
     * @return
     */
