...
public class CollisionResponse {
     ...
     * 'collisionResponse'
     *
     * @param physicObject      : the physic object
     * @param collisionResponse : the collision response, (returned by
     *                          {@link #detectAABB(WorldObject, WorldObject)}
     * @param absorption        : amount of velocity to be absorbed by the collision
     */
     ...
     * @param collisionResponse : the collision response, (returned by
     *                          {@link #detectAABB(WorldObject, WorldObject)}
     * @param vx,               vy, vz : velocities on collision
     * @param absorption        : velocity percentage to be absorbed
     */
