...
package net.thegaminghuskymc.sandboxgame.engine.registries;
...
//            ModContainer mc = Loader.instance().activeModContainer();
            String prefix = "blockitect"/*mc == null || (mc instanceof InjectedModContainer && ((InjectedModContainer)mc).wrappedContainer instanceof FMLContainer) ? "minecraft" : mc.getModId().toLowerCase()*/;
