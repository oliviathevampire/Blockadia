...
import net.thegaminghuskymc.sandboxgame.game.client.renderer.gui.font.FontFile;
import org.lwjgl.glfw.GLFW;

public class GuiPrompt extends GuiLabel {

    public static final TextTestFormat FORMAT_FLOAT = text -> {
    ...
    public interface TextTestFormat {
        /**
         * @param text : the new string to be set
