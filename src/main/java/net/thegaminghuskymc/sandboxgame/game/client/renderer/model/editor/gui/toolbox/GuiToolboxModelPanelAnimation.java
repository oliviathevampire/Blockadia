...
import net.thegaminghuskymc.sandboxgame.game.client.renderer.model.editor.gui.*;
import net.thegaminghuskymc.sandboxgame.game.client.renderer.model.instance.AnimationInstance;
            ...
            public void invoke(GuiEventClick<GuiButton> event) {
                ...
                new GuiWindowNewAnimation(new GuiPopUpCallback<GuiWindowNewAnimation>() {
                    ...
                    public void onConfirm(GuiWindowNewAnimation popUp) {
                        ...
                        BlockitectEngineClient.instance().getRenderer().getGuiRenderer().toast("Animation added");
