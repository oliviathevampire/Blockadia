...
import net.thegaminghuskymc.sandboxgame.game.client.renderer.model.editor.mesher.EditableModelMeshingEvent;
...
public class GuiToolbox extends Gui {
    ...
    private final void importModel(String absolutePath) {
        ...
        BlockitectEngineClient.instance().getResourceManager().getEventManager()
