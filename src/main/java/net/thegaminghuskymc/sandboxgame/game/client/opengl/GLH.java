...
public class GLH {
	...
	public static void glhInit() {
		...
		Logger.get().log(Logger.Level.FINE, "OpenGL initialized.");
	}

	/** set the opengl context to the given window */
	public static void glhSetContext(GLFWContext context) {
		Logger.get().log(Logger.Level.FINE, "OpenGL context set: " + context);
		// set current context
	...
	public static void glhAddObject(GLObject object) {
		if (DEBUG) {
			Logger.get().log(Logger.Level.DEBUG, "GLH: adding", object.getClass().getSimpleName());
		}
	...
	public static void glhDeleteObject(GLObject object) {
		...
		if (DEBUG) {
			Logger.get().log(Logger.Level.DEBUG, "GLH: removing", object.getClass().getSimpleName());
		}
	...
	public static void glhCheckError(String label) {
		...
		Logger.get().log(Logger.Level.ERROR, label + " : GLH error check: " + str);
	}
	...
	public static GLFWWindow glhCreateWindow() {
		...
		window.create(DEFAULT_SCREEN_WIDTH, DEFAULT_SCREEN_HEIGHT, "Blockitect");
