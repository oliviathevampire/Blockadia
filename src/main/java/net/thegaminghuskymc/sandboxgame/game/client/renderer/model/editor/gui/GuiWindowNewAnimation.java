...
public class GuiWindowNewAnimation extends GuiPopUp {

	public final GuiPrompt name;

	public GuiWindowNewAnimation(GuiPopUpCallback<GuiWindowNewAnimation> callback) {
		super(callback);
		...
		super.getInfoText().setText("Please enter the name of the new animation");

		this.name = new GuiPrompt();
		this.name.setHint("enter animation name");
