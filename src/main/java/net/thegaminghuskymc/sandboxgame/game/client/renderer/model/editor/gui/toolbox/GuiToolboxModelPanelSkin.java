...
import net.thegaminghuskymc.sandboxgame.game.client.renderer.model.editor.gui.GuiWindowNewSkin;
            ...
            public void invoke(GuiEventClick<GuiButton> event) {
                ...
                new GuiWindowNewSkin(new GuiPopUpCallback<GuiWindowNewSkin>() {
                    ...
                    public void onConfirm(GuiWindowNewSkin popUp) {
                        ...
                        BlockitectEngineClient.instance().getRenderer().getGuiRenderer().toast("Skin added");
                    }
