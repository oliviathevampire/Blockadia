...
import net.thegaminghuskymc.sandboxgame.server.management.PlayerChunkMapEntry;
import net.thegaminghuskymc.sandboxgame.util.WeightedRandom;
                ...
                for (int j1 = 0; j1 < i; ++j1)
                {
                    ...
                    for (int k1 = 0; !flag && k1 < 4; ++k1)
                    {
                        ...
                        if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, blockpos))
                        {
                            ...
                            if (ForgeEventFactory.canEntitySpawn(entityliving, worldIn, j + 0.5f, (float) blockpos.getY(), k +0.5f, false) == Event.Result.DENY) continue;
