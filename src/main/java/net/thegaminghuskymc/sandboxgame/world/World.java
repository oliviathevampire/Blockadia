...
import net.thegaminghuskymc.sandboxgame.entity.EnumCreatureType;
...
import net.thegaminghuskymc.sandboxgame.init.Biomes;
...
import net.thegaminghuskymc.sandboxgame.world.biome.BiomeProvider;
import net.thegaminghuskymc.sandboxgame.world.border.WorldBorder;
import net.thegaminghuskymc.sandboxgame.world.chunk.Chunk;
import net.thegaminghuskymc.sandboxgame.world.chunk.IChunkProvider;
...
import net.thegaminghuskymc.sgf.common.ForgeChunkManager;
...
import net.thegaminghuskymc.sgf.event.world.GetCollisionBoxesEvent;
...
public abstract class World implements IBlockAccess, ICapabilityProvider {
    ...
    public java.util.ArrayList<BlockSnapshot> capturedBlockSnapshots = new java.util.ArrayList<BlockSnapshot>();
    /**
    ...
    public void notifyNeighborsOfStateChange(BlockPos pos, Block blockType, boolean updateObservers) {
        if (ForgeEventFactory.onNeighborNotify(this, pos, this.getBlockState(pos), java.util.EnumSet.allOf(EnumFacing.class), updateObservers).isCanceled())
            return;
    ...
    public boolean spawnEntity(Entity entityIn) {
        ...
        if (!flag && !this.isChunkLoaded(i, j, false)) {
            ...
            if (GameEngine.EVENT_BUS.post(new EntityJoinWorldEvent(entityIn, this)) && !flag) return false;
    ...
    private boolean getCollisionBoxes(@Nullable Entity entityIn, AxisAlignedBB aabb, boolean p_191504_3_, @Nullable List<AxisAlignedBB> outList) {
        ...
        if (p_191504_3_ && !ForgeEventFactory.gatherCollisionBoxes(this, entityIn, aabb, outList)) return true;
        try {
    ...
    public List<AxisAlignedBB> getCollisionBoxes(@Nullable Entity entityIn, AxisAlignedBB aabb) {
        ...
        GameEngine.EVENT_BUS.post(new GetCollisionBoxesEvent(this, entityIn, aabb, list));
        return list;
    }
        ...
        for (int i1 = 0; i1 < this.loadedEntityList.size(); ++i1) {
            ...
            if (!entity2.isDead && !(entity2 instanceof EntityPlayerMP)) {
                try {
                    ...
                    if (ForgeModContainer.removeErroringEntities) {
                        FMLLog.log.fatal("{}", crashreport1.getCompleteReport());
    ...
    public void updateEntityWithOptionalForce(Entity entityIn, boolean forceUpdate) {
        if (!(entityIn instanceof EntityPlayer)) {
            ...
            boolean isForced = getPersistentChunks().containsKey(new ChunkPos(j2 >> 4, k2 >> 4));
    ...
    public void loadEntities(Collection<Entity> entityCollection) {
        for (Entity entity4 : entityCollection) {
            if (!GameEngine.EVENT_BUS.post(new net.minecraftforge.event.entity.EntityJoinWorldEvent(entity4, this))) {
    ...
    public void joinEntityInSurroundings(Entity entityIn) {
        ...
        if (!this.loadedEntityList.contains(entityIn)) {
            if (!GameEngine.EVENT_BUS.post(new net.minecraftforge.event.entity.EntityJoinWorldEvent(entityIn, this)))
                this.loadedEntityList.add(entityIn);
        }
    }
     ...
     * @return
     */
    public com.google.common.collect.ImmutableSetMultimap<ChunkPos, ForgeChunkManager.Ticket> getPersistentChunks() {
    ...
    protected void initCapabilities() {
        ICapabilityProvider parent = provider.initCapabilities();
        capabilities = ForgeEventFactory.gatherCapabilities(this, parent);
        WorldCapabilityData data = (WorldCapabilityData) perWorldStorage.getOrLoadData(WorldCapabilityData.class, WorldCapabilityData.ID);
        if (data == null) {
