...
import net.thegaminghuskymc.sandboxgame.server.management.PlayerChunkMap;
...
public class WorldServer extends World implements IThreadListener {
    ...
    protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
        ...
        List<EntityLivingBase> list = this.getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb, (com.google.common.base.Predicate<EntityLivingBase>) p_apply_1_ -> p_apply_1_ != null && p_apply_1_.isEntityAlive() && WorldServer.this.canSeeSky(p_apply_1_.getPosition()));
