package net.thegaminghuskymc.sandboxgame.world.chunk.storage;
...
import net.thegaminghuskymc.sandboxgame.world.chunk.NibbleArray;
...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
    ...
    public void saveChunk(World worldIn, Chunk chunkIn) throws MinecraftException, IOException {
        ...
        try {
            ...
            ForgeChunkManager.storeChunkNBT(chunkIn, nbttagcompound1);
            GameEngine.EVENT_BUS.post(new ChunkDataEvent.Save(chunkIn, nbttagcompound));
    ...
    private void writeChunkToNBT(Chunk chunkIn, World worldIn, NBTTagCompound compound) {
        ...
        for (int i = 0; i < chunkIn.getEntityLists().length; ++i) {
            for (Entity entity : chunkIn.getEntityLists()[i]) {
                ...
                try {
                    ...
                    FMLLog.log.error("An Entity type {} has thrown an exception trying to write state. It will not persist. Report this to the mod author",
        ...
        for (TileEntity tileentity : chunkIn.getTileEntityMap().values()) {
            try {
                ...
                FMLLog.log.error("A TileEntity type {} has throw an exception trying to write state. It will not persist. Report this to the mod author",
