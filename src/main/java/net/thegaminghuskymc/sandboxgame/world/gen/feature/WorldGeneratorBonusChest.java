        ...
        if (position.getY() < 1) {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                if (worldIn.isAirBlock(blockpos) && worldIn.getBlockState(blockpos.down()).isSideSolid(worldIn, blockpos.down(), net.minecraft.util.EnumFacing.UP)) {
                    ...
                    if (worldIn.isAirBlock(blockpos2) && worldIn.getBlockState(blockpos2.down()).isSideSolid(worldIn, blockpos2.down(), EnumFacing.UP)) {
                        worldIn.setBlockState(blockpos2, Blocks.TORCH.getDefaultState(), 2);
                    }

                    if (worldIn.isAirBlock(blockpos1) && worldIn.getBlockState(blockpos1.down()).isSideSolid(worldIn, blockpos1.down(), EnumFacing.UP)) {
                        worldIn.setBlockState(blockpos1, Blocks.TORCH.getDefaultState(), 2);
                    }

                    if (worldIn.isAirBlock(blockpos3) && worldIn.getBlockState(blockpos3.down()).isSideSolid(worldIn, blockpos3.down(), EnumFacing.UP)) {
                        worldIn.setBlockState(blockpos3, Blocks.TORCH.getDefaultState(), 2);
                    }

                    if (worldIn.isAirBlock(blockpos4) && worldIn.getBlockState(blockpos4.down()).isSideSolid(worldIn, blockpos4.down(), EnumFacing.UP)) {
