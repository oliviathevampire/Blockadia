...
import net.thegaminghuskymc.sandboxgame.world.chunk.storage.AnvilChunkLoader;
import net.thegaminghuskymc.sandboxgame.world.chunk.storage.IChunkLoader;
import net.thegaminghuskymc.sgf.common.DimensionManager;
import net.thegaminghuskymc.sgf.common.ForgeChunkManager;
import net.thegaminghuskymc.sgf.common.chunkio.ChunkIOExecutor;
...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public Chunk loadChunk(int x, int z, @Nullable Runnable runnable)
    {
        ...
        if (chunk == null)
        {
            ...
            {
                if (!loadingChunks.add(pos)) FMLLog.bigWarning("There is an attempt to load a chunk ({},{}) in dimension {} that is already being loaded. This will cause weird chunk breakages.", x, z, this.world.provider.getDimension());
            ...
            if (!this.droppedChunksSet.isEmpty())
            {
                ...
                for (int i = 0; i < 100 && iterator.hasNext(); iterator.remove())
                {
                    ...
                    if (chunk != null && chunk.unloadQueued)
                    {
                        ...
                        ++i;
                        if (id2ChunkMap.size() == 0 && ForgeChunkManager.getPersistentChunksFor(this.world).size() == 0 && !this.world.provider.getDimensionType().shouldLoadSpawn()){
