...
public class WorldGenSavannaTree extends WorldGenAbstractTree {
    private static final IBlockState TRUNK = Blocks.LOG2.getDefaultState().withProperty(BlockLogs.VARIANT, BlockPlank.EnumType.ACACIA);
    private static final IBlockState LEAF = Blocks.LEAVES2.getDefaultState().withProperty(BlockLeaves.VARIANT, BlockPlank.EnumType.ACACIA).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
