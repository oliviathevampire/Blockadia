...
import net.thegaminghuskymc.sandboxgame.world.gen.structure.template.PlacementSettings;
import net.thegaminghuskymc.sandboxgame.world.gen.structure.template.Template;
