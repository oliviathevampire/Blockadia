package net.thegaminghuskymc.sandboxgame.world.biome;
...
import net.thegaminghuskymc.sandboxgame.world.gen.NoiseGeneratorPerlin;
...
public abstract class Biome extends IForgeRegistryEntry.Impl<Biome> {
    ...
    public static final RegistryNamespaced<ResourceLocation, Biome> REGISTRY = GameData.getWrapper(Biome.class);
