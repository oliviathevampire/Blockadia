...
import net.thegaminghuskymc.sandboxgame.util.math.Cartesian;
import net.thegaminghuskymc.sandboxgame.util.math.RayTraceResult;
import net.thegaminghuskymc.sgf.fml.common.property.ExtendedBlockState;
import net.thegaminghuskymc.sgf.fml.common.property.IUnlistedProperty;
import net.thegaminghuskymc.sgf.fml.relauncher.Side;
import net.thegaminghuskymc.sgf.fml.relauncher.SideOnly;
import net.thegaminghuskymc.util.MapPopulator;
...
public class BlockStateContainer {
    ...
    public BlockStateContainer(Block blockIn, IProperty<?>[] properties) {
        ...
        for (List<Comparable<?>> list : Cartesian.cartesianProduct(this.getAllowedValues())) {
            ...
            BlockStateContainer.StateImplementation blockstatecontainer$stateimplementation = createState(blockIn, ImmutableMap.copyOf(map1));
    ...
    private static <T extends Comparable<T>> void validateProperty(Block block, IProperty<T> property) {
    ...
    private List<Iterable<Comparable<?>>> getAllowedValues() {
        ...
        for (Object anImmutablecollection : immutablecollection) {
            IProperty<?> iproperty = (IProperty) anImmutablecollection;
            ((IProperty) iproperty).getAllowedValues().add(list);
        }
    ...
    public static class StateImplementation extends BlockStateBase {
        ...
        void buildPropertyValueTable(Map<Map<IProperty<?>, Comparable<?>>, BlockStateContainer.StateImplementation> map) {
            if (this.propertyValueTable != null) {
                ...
                for (Object o : this.properties.entrySet()) {
                    Entry<IProperty<?>, Comparable<?>> entry = (Entry) o;
