...
import net.thegaminghuskymc.sandboxgame.entity.IEntityLivingData;
...
import net.thegaminghuskymc.sandboxgame.util.WeightedSpawnerEntity;
        ...
        else
        {
            ...
            else
            {
                ...
                for (int i = 0; i < this.spawnCount; ++i)
                {
                    ...
                    if (entityliving == null || ForgeEventFactory.canEntitySpawnSpawner(entityliving, getSpawnerWorld(), (float)entity.posX, (float)entity.posY, (float)entity.posZ, this))
                    {
