...
import net.thegaminghuskymc.sandboxgame.scoreboard.IScoreCriteria;
import net.thegaminghuskymc.sandboxgame.scoreboard.ScoreCriteriaStat;
import net.thegaminghuskymc.sandboxgame.util.IJsonSerializable;
