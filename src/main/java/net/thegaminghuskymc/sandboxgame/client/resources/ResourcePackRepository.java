...
import net.thegaminghuskymc.sandboxgame.client.renderer.texture.TextureUtil;
import net.thegaminghuskymc.sandboxgame.client.resources.FileResourcePack;
import net.thegaminghuskymc.sandboxgame.client.resources.FolderResourcePack;
