...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        ...
        java.util.List<Tuple<ResourceLocation, SoundList>> resources = new java.util.LinkedList<>();
        ...
        ProgressManager.ProgressBar resourcesBar = ProgressManager.push("Loading sounds", resources.size());
