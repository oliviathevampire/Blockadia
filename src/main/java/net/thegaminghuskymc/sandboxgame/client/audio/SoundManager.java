...
public class SoundManager {
    ...
    public SoundManager(SoundHandler p_i45119_1_, GameSettings p_i45119_2_) {
        ...
        try {
            ...
            GameEngine.EVENT_BUS.post(new SoundSetupEvent(this));
    ...
    public void reloadSoundSystem() {
        ...
        GameEngine.EVENT_BUS.post(new net.minecraftforge.client.event.sound.SoundLoadEvent(this));
    }
                    ...
                    if (sound == SoundHandler.MISSING_SOUND) {
                        ...
                        if (f1 == 0.0F) {
                            ...
                            if (sound.isStreaming()) {
                                ...
                                GameEngine.EVENT_BUS.post(new PlayStreamingSourceEvent(this, p_sound, s));
                            } else {
                                ...
                                GameEngine.EVENT_BUS.post(new PlaySoundSourceEvent(this, p_sound, s));
                            }
