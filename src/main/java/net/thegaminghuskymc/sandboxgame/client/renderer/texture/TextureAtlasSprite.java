...
import net.thegaminghuskymc.sandboxgame.client.resources.data.AnimationFrame;
import net.thegaminghuskymc.sandboxgame.client.resources.data.AnimationMetadataSection;
import net.thegaminghuskymc.sandboxgame.client.resources.data.PngSizeInfo;
...
public class TextureAtlasSprite {
    ...
    public static int[][] getFrameTextureData(int[][] data, int rows, int columns, int p_147962_3_) {
    ...
    public void allocateFrameTextureData(int index) {
