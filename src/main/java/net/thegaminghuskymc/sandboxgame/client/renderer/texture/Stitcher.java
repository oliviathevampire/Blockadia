...
import net.thegaminghuskymc.sandboxgame.client.renderer.StitcherException;
...
public class Stitcher {
    ...
    public void doStitch() {
        ...
        ProgressManager.ProgressBar bar = ProgressManager.push("Texture stitching", astitcher$holder.length);
