...
import net.thegaminghuskymc.sandboxgame.client.resources.ResourcePackRepository;
...
import net.thegaminghuskymc.sandboxgame.client.main.GameConfiguration;
import net.thegaminghuskymc.sandboxgame.client.renderer.*;
import net.thegaminghuskymc.sandboxgame.client.renderer.texture.DynamicTexture;
...
import net.thegaminghuskymc.sandboxgame.client.settings.KeyBinding;
...
import net.thegaminghuskymc.sandboxgame.init.Bootstrap;
import net.thegaminghuskymc.sandboxgame.init.Items;
import net.thegaminghuskymc.sandboxgame.item.ItemStack;
import net.thegaminghuskymc.sandboxgame.network.EnumConnectionState;
import net.thegaminghuskymc.sandboxgame.network.NetworkManager;
import net.thegaminghuskymc.sandboxgame.profiler.ISnooperInfo;
import net.thegaminghuskymc.sandboxgame.profiler.Profiler;
import net.thegaminghuskymc.sandboxgame.profiler.Snooper;
import net.thegaminghuskymc.sandboxgame.util.datafix.DataFixer;
import net.thegaminghuskymc.sandboxgame.util.datafix.DataFixesManager;
import net.thegaminghuskymc.sandboxgame.world.WorldSettings;
import net.thegaminghuskymc.sandboxgame.world.storage.ISaveFormat;
...
import net.thegaminghuskymc.sandboxgame.nbt.NBTTagString;
...
import net.thegaminghuskymc.sandboxgame.world.chunk.storage.AnvilSaveConverter;
import net.thegaminghuskymc.sgf.fml.client.FMLClientHandler;
import net.thegaminghuskymc.sgf.fml.common.FMLCommonHandler;
import net.thegaminghuskymc.sgf.fml.common.ProgressManager;
import net.thegaminghuskymc.sgf.fml.relauncher.Side;
import net.thegaminghuskymc.sgf.fml.relauncher.SideOnly;
import net.thegaminghuskymc.util.Session;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    private static final List<DisplayMode> MAC_DISPLAY_MODES = Lists.newArrayList(new DisplayMode(2560, 1600, 16, 64), new DisplayMode(2880, 1800, 16, 64));
    /**
    ...
    private void init() throws IOException {
        ...
        FMLClientHandler.instance().beginMinecraftLoading(this, this.defaultResourcePacks, this.mcResourceManager, this.metadataSerializer_);
        ...
        SplashProgress.clearVanillaResources(renderEngine, mojangLogo);
    ...
    private void createDisplay() {
        GLFW.glfwCreateWindow(this.displayWidth, this.displayHeight, "Husky's Voxel Engine 0.0.1", GLFW.glfwGetPrimaryMonitor(), 0);
    }
    ...
    public void loadWorld(@Nullable WorldClient worldClientIn, String loadingMessage) {
        if (world != null) GameEngine.EVENT_BUS.post(new WorldEvent.Unload(world));
