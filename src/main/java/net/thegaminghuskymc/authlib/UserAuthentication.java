...
public interface UserAuthentication {
     ...
     * and that username is valid but migrated to a Mojang account ("steve@minecraft.net"), a {@link net.thegaminghuskymc.authlib.exceptions.UserMigratedException}
     * will be thrown.
     *
     * @throws net.thegaminghuskymc.authlib.exceptions.AuthenticationUnavailableException Thrown when the servers return a malformed response, or are otherwise unavailable
     * @throws net.thegaminghuskymc.authlib.exceptions.InvalidCredentialsException Thrown when the specified credentials are invalid
     * @throws net.thegaminghuskymc.authlib.exceptions.UserMigratedException Thrown when attempting to authenticate with a {@link #setUsername(String) username} that has been migrated to an email address
     * @throws net.thegaminghuskymc.authlib.exceptions.AuthenticationException Generic exception indicating that we could not authenticate the user
     */
     ...
     * @throws net.thegaminghuskymc.authlib.exceptions.AuthenticationException User is not currently {@link #isLoggedIn() logged in},
     ...
     * <p />
     * This may be used to load an approximation of the current state from a past {@link net.thegaminghuskymc.authlib.UserAuthentication} with {@link #saveForStorage()}.
     *
     ...
     * <p />
     * This may be used to save an approximation of the current state for a future {@link net.thegaminghuskymc.authlib.UserAuthentication} with {@link #loadFromStorage(java.util.Map)}.
     *
